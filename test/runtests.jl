...
if GROUP == "All" || GROUP == "Core"
    @safetestset "Version bumping" begin
        using OrgMaintenanceScripts
        using Test
    ...
    @safetestset "Project file handling" begin
        using OrgMaintenanceScripts
        using Test
        using TOML
    ...
    @safetestset "Repository processing" begin
        using OrgMaintenanceScripts
        using Test
        using TOML
    ...
    @safetestset "Basic functionality (legacy)" begin
        using OrgMaintenanceScripts
        using Test
    ...
    @safetestset "Formatting Functions" begin
        include("formatting_tests.jl")
    end
    @safetestset "Minimum Version Fixer Tests" begin
        include("min_version_fixer_tests.jl")
    end
    @safetestset "Version Check Finder Tests" begin
        include("version_check_finder_tests.jl")
    end
    @safetestset "Invalidation Analysis Tests" begin
        include("invalidation_analysis_tests.jl")
    end
    @safetestset "Import Timing Analysis Tests" begin
        include("import_timing_analysis_tests.jl")
    end
    @safetestset "Explicit Imports Fixer" begin
        include("explicit_imports_fixer_tests.jl")
    end
    # Temporarily commented out due to syntax error in multiprocess_testing.jl
    # @safetestset "Multiprocess Testing" begin
    #     include("multiprocess_testing_tests.jl")
    # end
    @safetestset "Documentation Cleanup Tests" begin
