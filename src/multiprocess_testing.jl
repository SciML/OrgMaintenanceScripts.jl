"""
Multiprocess Testing Module for SciML Organization

This module provides functionality to run tests in parallel similar to GitHub Actions CI,
but locally. It parses CI workflow files, extracts test groups, and runs them in parallel
